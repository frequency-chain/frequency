...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletMessagesIpfsPayload: PalletMessagesIpfsPayload;
    ...
    PalletMsaCheckProviderRevocation: PalletMsaCheckProviderRevocation;
