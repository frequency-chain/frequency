...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    messages: {
      /**
       * Get messages by schemaId paginated
       **/
      getBySchema: AugmentedRpc<(schema_id: SchemaId | AnyNumber | Uint8Array, pagination: BlockPaginationRequest | { from_block?: any; from_index?: any; to_block?: any; page_size?: any } | string | Uint8Array) => Observable<BlockPaginationResponseMessage>>;
    };
    mmr: {
      /**
