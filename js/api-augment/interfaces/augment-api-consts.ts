...
declare module '@polkadot/api-base/types/consts' {
  interface AugmentedConsts<ApiType extends ApiTypes> {
    ...
    messages: {
       ...
       **/
      maxMessagePayloadSizeBytes: u32 & AugmentedConst<ApiType>;
      /**
    ...
    schemas: {
       ...
       **/
      maxSchemaRegistrations: u16 & AugmentedConst<ApiType>;
      /**
       * Minimum length of Schema model size in bytes
       **/
      minSchemaModelSizeBytes: u32 & AugmentedConst<ApiType>;
      /**
       * Maximum length of a Schema model Bounded Vec
       **/
      schemaModelMaxBytesBoundedVecLimit: u32 & AugmentedConst<ApiType>;
    };
    system: {
      /**
