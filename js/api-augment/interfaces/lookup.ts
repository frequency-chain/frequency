...
export default {
  ...
  /**
   * Lookup87: pallet_msa::pallet::Event<T>
   **/
  PalletMsaEvent: {
    _enum: {
      MsaCreated: {
  ...
  /**
   * Lookup90: pallet_messages::pallet::Event<T>
   **/
  PalletMessagesEvent: {
    _enum: {
      MessagesStored: {
  ...
  /**
   * Lookup92: pallet_schemas::pallet::Event<T>
   **/
  PalletSchemasEvent: {
    _enum: {
  ...
  /**
   * Lookup116: polkadot_primitives::v2::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup119: polkadot_primitives::v2::UpgradeRestriction
   **/
  PolkadotPrimitivesV2UpgradeRestriction: {
    _enum: ['Present']
  },
  /**
   * Lookup120: sp_trie::storage_proof::StorageProof
   **/
  SpTrieStorageProof: {
    trieNodes: 'BTreeSet<Bytes>'
  },
  /**
   * Lookup122: cumulus_pallet_parachain_system::relay_state_snapshot::MessagingStateSnapshot
   **/
  ...
  /**
   * Lookup125: polkadot_primitives::v2::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup126: polkadot_primitives::v2::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup132: polkadot_core_primitives::OutboundHrmpMessage<polkadot_parachain::primitives::Id>
   **/
  ...
  /**
   * Lookup133: cumulus_pallet_parachain_system::pallet::Call<T>
   **/
  ...
  /**
   * Lookup134: cumulus_primitives_parachain_inherent::ParachainInherentData
   **/
  ...
  /**
   * Lookup136: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup139: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup142: cumulus_pallet_parachain_system::pallet::Error<T>
   **/
  ...
  /**
   * Lookup162: cumulus_pallet_xcmp_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup163: pallet_xcm::pallet::Call<T>
   **/
  PalletXcmCall: {
    _enum: {
      send: {
  ...
  /**
   * Lookup164: xcm::VersionedXcm<Call>
   **/
  XcmVersionedXcm: {
    _enum: {
      V0: 'XcmV0Xcm',
  ...
  /**
   * Lookup167: xcm::v0::order::Order<Call>
   **/
  XcmV0Order: {
    _enum: {
      Null: 'Null',
  ...
  /**
   * Lookup172: xcm::v1::order::Order<Call>
   **/
  XcmV1Order: {
    _enum: {
      Noop: 'Null',
  ...
  /**
   * Lookup189: cumulus_pallet_dmp_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup190: pallet_msa::pallet::Call<T>
   **/
  PalletMsaCall: {
    _enum: {
      create: 'Null',
  ...
  /**
   * Lookup197: pallet_msa::types::AddProvider
   **/
  ...
  /**
   * Lookup198: pallet_msa::types::AddKeyData
   **/
  PalletMsaAddKeyData: {
    msaId: 'u64',
    nonce: 'u32'
  ...
  /**
   * Lookup199: pallet_messages::pallet::Call<T>
   **/
  PalletMessagesCall: {
    _enum: {
      add_ipfs_message: {
        ...
        schemaId: 'u16',
        payload: 'PalletMessagesIpfsPayload',
      },
      add_onchain_message: {
        onBehalfOf: 'Option<u64>',
        schemaId: 'u16',
  ...
  /**
   * Lookup200: pallet_messages::types::IPFSPayload
   **/
  PalletMessagesIpfsPayload: {
    cid: 'Bytes',
    payloadLength: 'u32'
  },
  /**
   * Lookup202: pallet_schemas::pallet::Call<T>
   **/
  PalletSchemasCall: {
    _enum: {
      register_schema: {
  ...
  /**
   * Lookup204: common_primitives::schema::ModelType
   **/
  CommonPrimitivesSchemaModelType: {
    _enum: ['AvroBinary', 'Parquet']
  },
  /**
   * Lookup205: common_primitives::schema::PayloadLocation
   **/
  CommonPrimitivesSchemaPayloadLocation: {
    _enum: ['OnChain', 'IPFS']
  },
  /**
   * Lookup206: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  ...
  /**
   * Lookup211: frame_support::dispatch::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup215: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange']
  },
  /**
   * Lookup216: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup220: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooLarge', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested']
  },
  /**
   * Lookup222: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup223: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup226: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup228: pallet_balances::Releases
   **/
  PalletBalancesReleases: {
    _enum: ['V1_0_0', 'V2_0_0']
  },
  /**
   * Lookup229: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
  ...
  /**
   * Lookup233: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup237: pallet_collator_selection::pallet::CandidateInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup250: cumulus_pallet_xcmp_queue::InboundChannelDetails
   **/
  ...
  /**
   * Lookup251: cumulus_pallet_xcmp_queue::InboundState
   **/
  CumulusPalletXcmpQueueInboundState: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup254: polkadot_parachain::primitives::XcmpMessageFormat
   **/
  PolkadotParachainPrimitivesXcmpMessageFormat: {
    _enum: ['ConcatenatedVersionedXcm', 'ConcatenatedEncodedBlob', 'Signals']
  },
  /**
   * Lookup257: cumulus_pallet_xcmp_queue::OutboundChannelDetails
   **/
  ...
  /**
   * Lookup258: cumulus_pallet_xcmp_queue::OutboundState
   **/
  ...
  /**
   * Lookup263: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
    _enum: ['Unreachable', 'SendFailure', 'Filtered', 'UnweighableMessage', 'DestinationNotInvertible', 'Empty', 'CannotReanchor', 'TooManyAssets', 'InvalidOrigin', 'BadVersion', 'BadLocation', 'NoSubscription', 'AlreadySubscribed']
  },
  /**
   * Lookup264: cumulus_pallet_xcm::pallet::Error<T>
   **/
  CumulusPalletXcmError: 'Null',
  /**
   * Lookup265: cumulus_pallet_dmp_queue::ConfigData
   **/
  CumulusPalletDmpQueueConfigData: {
    maxIndividual: 'u64'
  },
  /**
   * Lookup266: cumulus_pallet_dmp_queue::PageIndexData
   **/
  ...
  /**
   * Lookup269: cumulus_pallet_dmp_queue::pallet::Error<T>
   **/
  CumulusPalletDmpQueueError: {
    _enum: ['Unknown', 'OverLimit']
  },
  /**
   * Lookup271: common_primitives::msa::ProviderInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup272: common_primitives::msa::KeyInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup274: pallet_msa::pallet::Error<T>
   **/
  PalletMsaError: {
  ...
  /**
   * Lookup277: pallet_messages::types::Message<MaxDataSize>
   **/
  ...
  /**
   * Lookup283: pallet_messages::pallet::Error<T>
   **/
  PalletMessagesError: {
  ...
  /**
   * Lookup284: pallet_schemas::types::Schema<MaxModelSize>
   **/
  PalletSchemasSchema: {
    modelType: 'CommonPrimitivesSchemaModelType',
    model: 'Bytes',
  ...
  /**
   * Lookup285: pallet_schemas::pallet::Error<T>
   **/
  PalletSchemasError: {
  ...
  /**
   * Lookup288: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup289: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup290: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup291: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup294: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup295: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup296: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup297: pallet_msa::CheckProviderRevocation<T>
   **/
