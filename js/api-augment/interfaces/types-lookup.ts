...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletMsaAddKeyData (224) */
  interface PalletMsaAddKeyData extends Struct {
    readonly msaId: u64;
    readonly nonce: u32;
  }

  /** @name PalletMessagesCall (225) */
  ...
  /** @name CommonPrimitivesSchemaModelType (228) */
  ...
  /** @name CommonPrimitivesSchemaPayloadLocation (229) */
  ...
  /** @name PalletSudoError (230) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletPreimageRequestStatus (231) */
  ...
  /** @name PalletDemocracyPreimageStatus (239) */
  ...
  /** @name PalletDemocracyReferendumInfo (240) */
  ...
  /** @name PalletDemocracyReferendumStatus (241) */
  ...
  /** @name PalletDemocracyVoteVoting (243) */
  ...
  /** @name PalletDemocracyDelegations (246) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (247) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyReleases (250) */
  ...
  /** @name PalletSchedulerScheduledV3 (254) */
  ...
  /** @name PalletBalancesReleases (264) */
  ...
  /** @name PalletCollectiveVotes (269) */
  ...
  /** @name PalletCollectiveError (270) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (279) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (281) */
  ...
  /** @name CumulusPalletXcmError (306) */
  type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (307) */
  interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: u64;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (308) */
  ...
  /** @name CumulusPalletDmpQueueError (311) */
  ...
  /** @name OrmlVestingModuleError (313) */
  ...
  /** @name PalletMessagesMessage (323) */
  ...
  /** @name PalletMsaCheckFreeExtrinsicUse (343) */
  type PalletMsaCheckFreeExtrinsicUse = Null;

  /** @name FrequencyRococoRuntimeRuntime (344) */
