...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletCollatorSelectionEvent (51) */
  ...
  /** @name PalletDemocracyConviction (163) */
  ...
  /** @name FrameSupportScheduleMaybeHashed (167) */
  ...
  /** @name FrequencyRococoRuntimeOriginCaller (170) */
  ...
  /** @name CumulusPalletXcmOrigin (175) */
  ...
  /** @name SpRuntimeBlakeTwo256 (185) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name PalletCollatorSelectionCall (186) */
  ...
  /** @name FrequencyRococoRuntimeSessionKeys (188) */
  ...
  /** @name CumulusPalletDmpQueueCall (217) */
  ...
  /** @name OrmlVestingModuleCall (218) */
  ...
  /** @name CommonPrimitivesSchemaModelType (234) */
  ...
  /** @name CommonPrimitivesSchemaPayloadLocation (235) */
  ...
  /** @name PalletSudoError (236) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletPreimageRequestStatus (237) */
  ...
  /** @name PalletDemocracyPreimageStatus (245) */
  ...
  /** @name PalletDemocracyReferendumInfo (246) */
  ...
  /** @name PalletDemocracyReferendumStatus (247) */
  ...
  /** @name PalletDemocracyVoteVoting (249) */
  ...
  /** @name PalletDemocracyDelegations (252) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (253) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyReleases (256) */
  interface PalletDemocracyReleases extends Enum {
    readonly isV1: boolean;
    readonly type: 'V1';
  }

  /** @name PalletDemocracyError (257) */
  ...
  /** @name PalletSchedulerScheduledV3 (260) */
  ...
  /** @name PalletBalancesReleases (270) */
  ...
  /** @name PalletAuthorshipUncleEntryItem (286) */
  ...
  /** @name PalletAuthorshipError (288) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (291) */
  interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (293) */
  ...
  /** @name CommonPrimitivesMsaProviderInfo (326) */
  ...
  /** @name PalletMessagesMessage (335) */
  ...
  /** @name CommonRuntimeExtensionsCheckNonce (352) */
  interface CommonRuntimeExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (353) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (354) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name PalletMsaCheckFreeExtrinsicUse (355) */
  type PalletMsaCheckFreeExtrinsicUse = Null;

  /** @name FrequencyRococoRuntimeRuntime (356) */
