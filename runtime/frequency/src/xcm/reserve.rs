...
use frame_support::{parameter_types, traits::ContainsPair, pallet_prelude::{PhantomData, Get}};
...
pub type TrustedReserves =
	(NativeAsset, ConcreteAssetFromSystem<RelayLocation>, AssetsFrom<AssetHubLocation>, AssetFromExcept<ExceptAsset>);
