...
use staging_xcm_builder::WeightInfoBounds;

use crate::xcm::MaxAssetsIntoHolding;
...
parameter_types! {
	pub const MaxInstructions: u32 = 20;
}
...
pub struct FrequencyXcmWeight<Call>(core::marker::PhantomData<Call>);
impl<Call> XcmWeightInfo<Call> for FrequencyXcmWeight<Call> {
	...
	fn transact(
		...
		// Frequency does not support transact calls
		Weight::MAX
	}
	...
	fn exchange_asset(_give: &AssetFilter, _receive: &Assets, _maximal: &bool) -> Weight {
		// Frequency does not support exchange calls
		Weight::MAX
	}
	...
	fn universal_origin(_: &Junction) -> Weight {
		// Frequency does not support universal_origin calls
		Weight::MAX
	}
	...
	fn lock_asset(_: &Asset, _: &Location) -> Weight {
		// Frequency does not support lock_asset calls
		Weight::MAX
	}

	fn unlock_asset(_: &Asset, _: &Location) -> Weight {
		// Frequency does not support unlock_asset calls
		Weight::MAX
	}

	fn note_unlockable(_: &Asset, _: &Location) -> Weight {
		// Frequency does not support note_unlockable calls
		Weight::MAX
	}

	fn request_unlock(_: &Asset, _: &Location) -> Weight {
		// Frequency does not support request_unlock calls
		Weight::MAX
	}
	...
	fn alias_origin(_: &Location) -> Weight {
		// Frequency does not support alias_origin calls
		Weight::MAX
	}
...
pub type Weigher = WeightInfoBounds<FrequencyXcmWeight<RuntimeCall>, RuntimeCall, MaxInstructions>;
