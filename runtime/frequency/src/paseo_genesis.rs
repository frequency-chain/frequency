...
pub fn paseo_invulnerables() -> Vec<(AccountId, AuraId)> {
	vec![
		(
...
pub fn paseo_root() -> Option<AccountId> {
	Some(get_account_id_from_seed::<sr25519::Public>("Alice"))
}

pub fn paseo_endowed_accounts() -> Vec<AccountId> {
	vec![
		get_account_id_from_seed::<sr25519::Public>("Alice"),
...
pub fn paseo_council_members() -> Vec<AccountId> {
	vec![
		get_account_id_from_seed::<sr25519::Public>("Alice"),
		get_account_id_from_seed::<sr25519::Public>("Charlie"),
		get_account_id_from_seed::<sr25519::Public>("Eve"),
...
pub fn paseo_technical_committee_members() -> Vec<AccountId> {
	vec![
		get_account_id_from_seed::<sr25519::Public>("Bob"),
		get_account_id_from_seed::<sr25519::Public>("Dave"),
	]
