...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for SubstrateWeight<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(3_393_000, 10399)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(5_991_036, 22838)
			// Standard Error: 1_566
			.saturating_add(Weight::from_parts(434_630, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_096_000, 12554)
			// Standard Error: 3
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_119_200, 22838)
			// Standard Error: 1_678
			.saturating_add(Weight::from_parts(450_851, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Scheduler Agenda (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_911_929, 22838)
			// Standard Error: 1_276
			.saturating_add(Weight::from_parts(694_701, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(18_050_849, 22838)
			// Standard Error: 2_892
			.saturating_add(Weight::from_parts(486_374, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Scheduler Lookup (r:1 w:1)
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_339_015, 22838)
			// Standard Error: 1_272
			.saturating_add(Weight::from_parts(723_185, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}
