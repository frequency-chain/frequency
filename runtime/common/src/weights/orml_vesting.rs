...
impl<T: frame_system::Config> orml_vesting::WeightInfo for SubstrateWeight<T> {
	...
	fn vested_transfer() -> Weight {
		Weight::from_ref_time(61_754_000 as u64)
	...
	fn claim(i: u32, ) -> Weight {
		Weight::from_ref_time(37_640_000 as u64)
			// Standard Error: 1_736
			.saturating_add(Weight::from_ref_time(141_782 as u64).saturating_mul(i as u64))
	...
	fn update_vesting_schedules(i: u32, ) -> Weight {
		Weight::from_ref_time(32_781_000 as u64)
			// Standard Error: 960
			.saturating_add(Weight::from_ref_time(85_492 as u64).saturating_mul(i as u64))
