...
impl<T: frame_system::Config> orml_vesting::WeightInfo for SubstrateWeight<T> {
	...
	fn vested_transfer() -> Weight {
		Weight::from_ref_time(58_615_000 as u64)
	...
	fn claim(i: u32, ) -> Weight {
		Weight::from_ref_time(38_595_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(83_000 as u64).saturating_mul(i as u64))
	...
	fn update_vesting_schedules(i: u32, ) -> Weight {
		Weight::from_ref_time(31_891_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(51_000 as u64).saturating_mul(i as u64))
