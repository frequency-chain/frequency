...
impl<T: frame_system::Config> pallet_balances::WeightInfo for SubstrateWeight<T> {
	...
	fn transfer_keep_alive() -> Weight {
		Weight::from_ref_time(31_932_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: System Account (r:1 w:1)
	fn set_balance_creating() -> Weight {
		Weight::from_ref_time(23_335_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: System Account (r:1 w:1)
	...
	fn force_transfer() -> Weight {
		Weight::from_ref_time(40_755_000 as u64)
	...
	fn force_unreserve() -> Weight {
		Weight::from_ref_time(20_457_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
