...
impl<T: frame_system::Config> pallet_democracy::WeightInfo for SubstrateWeight<T> {
	...
	fn propose() -> Weight {
		Weight::from_ref_time(65_417_000 as u64)
	...
	fn second(s: u32, ) -> Weight {
		Weight::from_ref_time(37_302_000 as u64)
	...
	fn vote_new(r: u32, ) -> Weight {
		Weight::from_ref_time(49_229_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(300_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Democracy ReferendumInfoOf (r:1 w:1)
	...
	fn vote_existing(r: u32, ) -> Weight {
		Weight::from_ref_time(49_320_000 as u64)
			// Standard Error: 1_000
	...
	fn emergency_cancel() -> Weight {
		Weight::from_ref_time(23_305_000 as u64)
	...
	fn external_propose(v: u32, ) -> Weight {
		Weight::from_ref_time(17_067_000 as u64)
			// Standard Error: 0
	...
	fn external_propose_majority() -> Weight {
		Weight::from_ref_time(5_171_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Democracy NextExternal (r:0 w:1)
	...
	fn fast_track() -> Weight {
		Weight::from_ref_time(23_572_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Democracy NextExternal (r:1 w:1)
	...
	fn veto_external(v: u32, ) -> Weight {
		Weight::from_ref_time(25_574_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(28_000 as u64).saturating_mul(v as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Democracy PublicProps (r:1 w:1)
	...
	fn cancel_referendum() -> Weight {
		Weight::from_ref_time(14_758_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn on_initialize_base(r: u32, ) -> Weight {
		Weight::from_ref_time(8_577_000 as u64)
	...
	fn on_initialize_base_with_launch_period(r: u32, ) -> Weight {
		Weight::from_ref_time(11_691_000 as u64)
			// Standard Error: 4_000
	...
	fn delegate(r: u32, ) -> Weight {
		Weight::from_ref_time(52_817_000 as u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(3_845_000 as u64).saturating_mul(r as u64))
	...
	fn undelegate(r: u32, ) -> Weight {
		Weight::from_ref_time(29_509_000 as u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(3_813_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn clear_public_proposals() -> Weight {
		Weight::from_ref_time(6_113_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn note_imminent_preimage(b: u32, ) -> Weight {
		Weight::from_ref_time(25_009_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(2_000 as u64).saturating_mul(b as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	...
	fn unlock_remove(r: u32, ) -> Weight {
		Weight::from_ref_time(36_362_000 as u64)
			// Standard Error: 1_000
	...
	fn remove_vote(r: u32, ) -> Weight {
		Weight::from_ref_time(20_768_000 as u64)
			// Standard Error: 1_000
	...
	fn remove_other_vote(r: u32, ) -> Weight {
		Weight::from_ref_time(20_454_000 as u64)
			// Standard Error: 1_000
