...
impl<T: frame_system::Config> pallet_democracy::WeightInfo for SubstrateWeight<T> {
	...
	fn propose() -> Weight {
		Weight::from_ref_time(63_408_000 as u64)
	...
	fn vote_new(r: u32, ) -> Weight {
		Weight::from_ref_time(49_223_000 as u64)
	...
	fn vote_existing(r: u32, ) -> Weight {
		Weight::from_ref_time(50_285_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(245_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Democracy ReferendumInfoOf (r:1 w:1)
	...
	fn external_propose(v: u32, ) -> Weight {
		Weight::from_ref_time(17_276_000 as u64)
			// Standard Error: 0
	...
	fn external_propose_default() -> Weight {
		Weight::from_ref_time(5_301_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Democracy NextExternal (r:1 w:1)
	...
	fn fast_track() -> Weight {
		Weight::from_ref_time(24_083_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Democracy NextExternal (r:1 w:1)
	...
	fn cancel_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(46_798_000 as u64)
			// Standard Error: 2_000
			.saturating_add(Weight::from_ref_time(321_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
	// Storage: Democracy ReferendumInfoOf (r:0 w:1)
	fn cancel_referendum() -> Weight {
		Weight::from_ref_time(15_146_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn cancel_queued(r: u32, ) -> Weight {
		Weight::from_ref_time(28_337_000 as u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(628_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	...
	fn on_initialize_base(r: u32, ) -> Weight {
		Weight::from_ref_time(9_585_000 as u64)
			// Standard Error: 4_000
			.saturating_add(Weight::from_ref_time(2_568_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn on_initialize_base_with_launch_period(r: u32, ) -> Weight {
		Weight::from_ref_time(12_288_000 as u64)
			// Standard Error: 4_000
			.saturating_add(Weight::from_ref_time(2_577_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(5 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn delegate(r: u32, ) -> Weight {
		Weight::from_ref_time(52_651_000 as u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(3_920_000 as u64).saturating_mul(r as u64))
	...
	fn undelegate(r: u32, ) -> Weight {
		Weight::from_ref_time(30_246_000 as u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(3_882_000 as u64).saturating_mul(r as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().reads((1 as u64).saturating_mul(r as u64)))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
			.saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(r as u64)))
	...
	fn clear_public_proposals() -> Weight {
		Weight::from_ref_time(6_376_000 as u64)
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Democracy Preimages (r:1 w:1)
	/// The range of component `b` is `[0, 16384]`.
	fn note_preimage(b: u32, ) -> Weight {
		Weight::from_ref_time(33_309_000 as u64)
			// Standard Error: 0
	...
	fn reap_preimage(b: u32, ) -> Weight {
		Weight::from_ref_time(43_502_000 as u64)
			// Standard Error: 0
	...
	fn unlock_remove(r: u32, ) -> Weight {
		Weight::from_ref_time(35_548_000 as u64)
			// Standard Error: 1_000
	...
	fn unlock_set(r: u32, ) -> Weight {
		Weight::from_ref_time(34_308_000 as u64)
			// Standard Error: 1_000
	...
	fn remove_vote(r: u32, ) -> Weight {
		Weight::from_ref_time(20_898_000 as u64)
			// Standard Error: 1_000
	...
	fn remove_other_vote(r: u32, ) -> Weight {
		Weight::from_ref_time(20_866_000 as u64)
			// Standard Error: 1_000
