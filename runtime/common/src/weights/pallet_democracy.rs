...
impl<T: frame_system::Config> pallet_democracy::WeightInfo for SubstrateWeight<T> {
	...
	fn propose() -> Weight {
		...
		Weight::from_parts(46_598_000, 19672)
	...
	fn second() -> Weight {
		...
		Weight::from_parts(40_043_000, 8180)
	...
	fn vote_new() -> Weight {
		...
		Weight::from_parts(58_522_000, 8745)
	...
	fn vote_existing() -> Weight {
		...
		Weight::from_parts(62_987_000, 8745)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Democracy::ReferendumInfoOf` (r:1 w:1)
	...
	fn emergency_cancel() -> Weight {
		...
		Weight::from_parts(25_353_000, 5151)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Democracy::PublicProps` (r:1 w:1)
	...
	fn blacklist() -> Weight {
		...
		//  Measured:  `5942`
		//  Estimated: `19672`
		// Minimum execution time: 95_582_000 picoseconds.
		Weight::from_parts(97_080_000, 19672)
	...
	fn external_propose() -> Weight {
		...
		Weight::from_parts(12_520_000, 8188)
	...
	fn fast_track() -> Weight {
		...
		Weight::from_parts(26_100_000, 5003)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn veto_external() -> Weight {
		...
		Weight::from_parts(29_297_000, 8188)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Democracy::PublicProps` (r:1 w:1)
	...
	fn cancel_proposal() -> Weight {
		...
		//  Measured:  `5853`
		//  Estimated: `19672`
		// Minimum execution time: 76_086_000 picoseconds.
		Weight::from_parts(78_198_000, 19672)
			.saturating_add(T::DbWeight::get().reads(4_u64))
	...
	fn cancel_referendum() -> Weight {
		...
		Weight::from_parts(18_610_000, 5003)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_initialize_base(r: u32, ) -> Weight {
		...
		Weight::from_parts(8_378_139, 2974)
			// Standard Error: 6_454
			.saturating_add(Weight::from_parts(3_152_208, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn on_initialize_base_with_launch_period(r: u32, ) -> Weight {
		...
		Weight::from_parts(11_855_784, 19672)
			// Standard Error: 6_323
			.saturating_add(Weight::from_parts(3_166_977, 0).saturating_mul(r.into()))
	...
	fn delegate(r: u32, ) -> Weight {
		...
		Weight::from_parts(46_682_353, 21285)
			// Standard Error: 7_503
			.saturating_add(Weight::from_parts(4_049_053, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(r.into())))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	...
	fn undelegate(r: u32, ) -> Weight {
		...
		Weight::from_parts(19_799_222, 15015)
			// Standard Error: 16_335
			.saturating_add(Weight::from_parts(3_995_660, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(r.into())))
			.saturating_add(T::DbWeight::get().writes(2_u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(r.into())))
	...
	fn unlock_remove(r: u32, ) -> Weight {
		...
		Weight::from_parts(38_317_037, 8745)
			// Standard Error: 3_568
			.saturating_add(Weight::from_parts(100_148, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Democracy::VotingOf` (r:1 w:1)
	...
	fn unlock_set(r: u32, ) -> Weight {
		...
		Weight::from_parts(36_833_773, 8745)
			// Standard Error: 2_356
			.saturating_add(Weight::from_parts(124_097, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Democracy::ReferendumInfoOf` (r:1 w:1)
	...
	fn remove_vote(r: u32, ) -> Weight {
		...
		Weight::from_parts(16_205_140, 8745)
			// Standard Error: 2_762
			.saturating_add(Weight::from_parts(191_932, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Democracy::ReferendumInfoOf` (r:1 w:1)
	...
	fn remove_other_vote(r: u32, ) -> Weight {
		...
		Weight::from_parts(18_505_939, 8745)
			// Standard Error: 3_402
			.saturating_add(Weight::from_parts(143_791, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Democracy::NextExternal` (r:1 w:0)
	...
	fn set_external_metadata() -> Weight {
		...
		Weight::from_parts(17_515_000, 5041)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Democracy::NextExternal` (r:1 w:0)
	...
	fn clear_external_metadata() -> Weight {
		...
		Weight::from_parts(15_861_000, 5003)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Democracy::PublicProps` (r:1 w:0)
	...
	fn set_proposal_metadata() -> Weight {
		...
		Weight::from_parts(43_213_000, 19672)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Democracy::PublicProps` (r:1 w:0)
	...
	fn clear_proposal_metadata() -> Weight {
		...
		Weight::from_parts(47_748_000, 19672)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn clear_referendum_metadata() -> Weight {
		...
		Weight::from_parts(18_038_000, 5151)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
