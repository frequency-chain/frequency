...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(24_759_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(4_070_000 as u64).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		Weight::from_ref_time(6_696_000 as u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(21_908_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_145_000 as u64).saturating_mul(c as u64))
	}
