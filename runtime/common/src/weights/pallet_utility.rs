...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(35_577_000 as u64)
			// Standard Error: 7_000
			.saturating_add(Weight::from_ref_time(3_588_000 as u64).saturating_mul(c as u64))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(20_833_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(3_645_000 as u64).saturating_mul(c as u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(14_263_000 as u64)
			// Standard Error: 7_000
			.saturating_add(Weight::from_ref_time(3_595_000 as u64).saturating_mul(c as u64))
	}
}
