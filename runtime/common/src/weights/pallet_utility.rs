...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(16_222_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_327_000 as u64).saturating_mul(c as u64))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(15_078_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_425_000 as u64).saturating_mul(c as u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(14_436_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_326_000 as u64).saturating_mul(c as u64))
	}
}
