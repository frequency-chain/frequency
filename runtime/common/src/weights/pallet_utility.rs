...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(6_397_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_188_000 as u64).saturating_mul(c as u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(16_133_000 as u64)
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(4_182_000 as u64).saturating_mul(c as u64))
	}
}
