// Copied from:
https://github.com/paritytech/polkadot-sdk/blob/polkadot-stable2509-rc1/substrate/.maintain/frame-weight-template.hbs
...
//! DATE: 2025-09-22, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH
RANGE: `[]`
...
pub struct WeightInfo<T>(PhantomData<T>);
		impl<T: frame_system::Config> frame_system::ExtensionsWeightInfo for WeightInfo<T> {
				...
				Weight::from_parts(8_751_000, 4088)
