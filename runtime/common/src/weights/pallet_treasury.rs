...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	...
	fn propose_spend() -> Weight {
		Weight::from_ref_time(31_425_000 as u64)
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(37_978_000 as u64)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(11_582_000 as u64)
			// Standard Error: 1_831
			.saturating_add(Weight::from_ref_time(277_998 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(29_484_000 as u64)
			// Standard Error: 14_200
			.saturating_add(Weight::from_ref_time(30_927_746 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
