...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	...
	fn propose_spend() -> Weight {
		Weight::from_ref_time(31_685_000 as u64)
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(37_696_000 as u64)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(11_547_000 as u64)
			// Standard Error: 1_557
			.saturating_add(Weight::from_ref_time(285_254 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Treasury Approvals (r:1 w:1)
	fn remove_approval() -> Weight {
		Weight::from_ref_time(9_939_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(30_016_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(30_523_644 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
