...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	fn spend() -> Weight {
		Weight::from_ref_time(145_000 as u64)
	}
	// Storage: Treasury ProposalCount (r:1 w:1)
	// Storage: Treasury Proposals (r:0 w:1)
	fn propose_spend() -> Weight {
		Weight::from_ref_time(29_787_000 as u64)
	...
	fn reject_proposal() -> Weight {
		Weight::from_ref_time(36_186_000 as u64)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		Weight::from_ref_time(12_993_000 as u64)
	...
	fn remove_approval() -> Weight {
		Weight::from_ref_time(9_831_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		Weight::from_ref_time(38_450_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(30_116_000 as u64).saturating_mul(p as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
