...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for SubstrateWeight<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(29_298_000, 5041)
			// Standard Error: 7
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_323_000, 5041)
			// Standard Error: 7
	...
	fn unnote_preimage() -> Weight {
		...
		Weight::from_parts(60_703_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unnote_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(34_864_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_preimage() -> Weight {
		...
		//  Measured:  `188`
		//  Estimated: `5041`
		// Minimum execution time: 29_819_000 picoseconds.
		Weight::from_parts(31_267_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn request_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(19_400_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(23_328_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_requested_preimage() -> Weight {
		...
		Weight::from_parts(10_847_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_parts(33_429_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(11_352_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_parts(11_080_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
