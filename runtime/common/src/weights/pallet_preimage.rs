...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for SubstrateWeight<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(30_422_000, 12466)
			// Standard Error: 6
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_480_000, 12466)
			// Standard Error: 6
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_794_000, 12466)
			// Standard Error: 5
			.saturating_add(Weight::from_parts(2_546, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn unnote_preimage() -> Weight {
		...
		Weight::from_parts(60_722_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn unnote_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(35_133_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn request_preimage() -> Weight {
		...
		Weight::from_parts(35_626_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn request_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(23_512_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(27_659_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn request_requested_preimage() -> Weight {
		...
		Weight::from_parts(11_475_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_parts(35_784_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(11_628_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: Preimage StatusFor (r:1 w:1)
	...
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_parts(12_383_000, 12466)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
