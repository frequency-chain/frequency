...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for SubstrateWeight<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(29_199_000, 5041)
			// Standard Error: 2
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_073_000, 5041)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(2_134, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_389_000, 5041)
			// Standard Error: 1
	...
	fn unnote_preimage() -> Weight {
		...
		Weight::from_parts(44_755_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unnote_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(26_244_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_preimage() -> Weight {
		...
		Weight::from_parts(22_760_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn request_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(13_737_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(14_838_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn request_requested_preimage() -> Weight {
		...
		Weight::from_parts(8_280_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_parts(24_224_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(8_253_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:1)
	...
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_parts(8_311_000, 5041)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
