...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	fn pay_with_capacity() -> Weight {
		Weight::from_ref_time(5_570_000 as u64)
	}
	fn pay_with_capacity_batch_all(n: u32, ) -> Weight {
		Weight::from_ref_time(13_936_886 as u64)
			// Standard Error: 69_281
			.saturating_add(Weight::from_ref_time(4_700_751 as u64).saturating_mul(n as u64))
	}
}
