...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn apply_item_actions(s: u32, ) -> Weight {
		Weight::from_ref_time(111_873_911 as u64)
			// Standard Error: 430
			.saturating_add(Weight::from_ref_time(6_113 as u64).saturating_mul(s as u64))
	...
	fn upsert_page(s: u32, ) -> Weight {
		Weight::from_ref_time(35_492_405 as u64)
			// Standard Error: 258
			.saturating_add(Weight::from_ref_time(404 as u64).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Schemas Schemas (r:1 w:0)
	...
	// Storage: unknown [0x0763c98381dc89abe38627fe2f98cb7af1577fbf1d628fdddb4ebfc6e8d95fb1] (r:1 w:1)
	fn delete_page() -> Weight {
		Weight::from_ref_time(38_961_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Msa PublicKeyToMsaId (r:1 w:0)
	...
	// Storage: unknown [0xbd1557c8db6bd8599a811a7175fbc2fc6400] (r:1 w:1)
	fn apply_item_actions_with_signature(s: u32, ) -> Weight {
		Weight::from_ref_time(165_331_427 as u64)
			// Standard Error: 465
			.saturating_add(Weight::from_ref_time(12_140 as u64).saturating_mul(s as u64))
	...
	// Storage: unknown [0x0763c98381dc89abe38627fe2f98cb7af1577fbf1d628fdddb4ebfc6e8d95fb1] (r:1 w:1)
	fn upsert_page_with_signature(s: u32, ) -> Weight {
		Weight::from_ref_time(90_358_801 as u64)
			// Standard Error: 643
			.saturating_add(Weight::from_ref_time(6_661 as u64).saturating_mul(s as u64))
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: Msa PublicKeyToMsaId (r:1 w:0)
	...
	// Storage: unknown [0x0763c98381dc89abe38627fe2f98cb7af1577fbf1d628fdddb4ebfc6e8d95fb1] (r:1 w:1)
	fn delete_page_with_signature() -> Weight {
		Weight::from_ref_time(92_493_000 as u64)
			.saturating_add(T::DbWeight::get().reads(3 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
