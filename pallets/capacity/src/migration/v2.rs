...
pub mod v1 {
    ...
    pub struct StakingAccountDetails<T: Config>
    {
        ...
        pub unlocking: BoundedVec<UnlockChunk<BalanceOf<T>, T::EpochNumber>, <T as crate::pallet::Config>::MaxUnlockingChunks>,
    }

    #[storage_alias]
    /// alias to StakingAccountLedger storage
    pub(crate) type StakingAccountLedger<T: Config> =
        StorageMap<Pallet<T>, Twox64Concat, <T as frame_system::Config>::AccountId, StakingAccountDetails<T>>;
...
pub fn migrate_to_v2<T: Config>() -> Weight {
    ...
    if on_chain_version.lt(&2) {
        ...
        StakingAccountLedger::<T>::translate(
            |key: <T as frame_system::Config>::AccountId, old_details: v1::StakingAccountDetails<T>| {
