...
#[test]
fn test_claim_handle_fails_if_claim_is_replayed_with_different_account() {
...
#[test]
fn test_claim_handle_fails_with_replay_attack_using_different_payload() {
	new_test_ext().execute_with(|| {
		let base_handle_str = "test1";
...
#[test]
fn test_retire_handle_fails_with_replay_attack_using_different_account() {
	new_test_ext().execute_with(|| {
		let base_handle_str = "test1";
...
#[test]
fn test_claim_handle_fails_when_claiming_for_another_msa_with_no_existing_handle() {
	new_test_ext().execute_with(|| {
		let base_handle_str = "test1";
...
#[test]
fn test_claim_handle_fails_when_proof_has_expired() {
	new_test_ext().execute_with(|| {
		let base_handle_str = "test1";
...
#[test]
fn test_claim_handle_fails_when_proof_is_not_yet_valid() {
	new_test_ext().execute_with(|| {
		let base_handle_str = "test1";
