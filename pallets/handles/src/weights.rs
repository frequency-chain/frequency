...
//! DATE: 2023-04-05, STEPS: `20`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn claim_handle(_b: u32, ) -> Weight {
		Weight::from_ref_time(794_182_904 as u64)
	...
	// Storage: Handles MSAIdToDisplayName (r:1 w:1)
	// Storage: Handles CanonicalBaseHandleAndSuffixToMSAId (r:0 w:1)
	fn retire_handle(_b: u32, ) -> Weight {
		Weight::from_ref_time(425_916_278 as u64)
