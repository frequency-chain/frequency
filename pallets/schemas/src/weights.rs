...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_schema(m: u32, n: u32, ) -> Weight {
		Weight::from_ref_time(71_924_000 as u64)
			// Standard Error: 70
			.saturating_add(Weight::from_ref_time(28_289 as u64).saturating_mul(m as u64))
			// Standard Error: 4_637
			.saturating_add(Weight::from_ref_time(61_069 as u64).saturating_mul(n as u64))
