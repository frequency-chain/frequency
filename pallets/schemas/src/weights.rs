...
//! DATE: 2022-12-20, STEPS: `20`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
// --repeat
// 5
// --output=./pallets/schemas/src/weights.rs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_schema(m: u32, ) -> Weight {
		Weight::from_ref_time(408_000_000 as u64)
			// Standard Error: 482
			.saturating_add(Weight::from_ref_time(226_468 as u64).saturating_mul(m as u64))
