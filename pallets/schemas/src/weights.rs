...
//! DATE: 2022-12-20, STEPS: `50`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_schema(m: u32, ) -> Weight {
		Weight::from_ref_time(20_626_000 as u64)
			// Standard Error: 20
			.saturating_add(Weight::from_ref_time(27_259 as u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(2 as u64))
	}
	// Storage: Schemas GovernanceSchemaModelMaxBytes (r:0 w:1)
	fn set_max_schema_model_bytes() -> Weight {
		Weight::from_ref_time(14_199_000 as u64)
