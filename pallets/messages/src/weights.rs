...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_ipfs_message(n: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(2_349_000 as u64)
			...
			// Standard Error: 1_000
			.saturating_add(Weight::from_ref_time(192_000 as u64).saturating_mul(m as u64))
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(356_000 as u64).saturating_mul(m as u64))
			// Standard Error: 81_000
			.saturating_add(Weight::from_ref_time(4_887_000 as u64).saturating_mul(s as u64))
