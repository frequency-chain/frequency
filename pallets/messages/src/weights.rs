...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(6_064_000 as u64)
			...
			.saturating_add(Weight::from_ref_time(220_000 as u64).saturating_mul(m as u64))
	...
	// Storage: Messages BlockMessages (r:1 w:1)
	fn add_ipfs_message(n: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(5_469_000 as u64)
			// Standard Error: 0
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(380_000 as u64).saturating_mul(m as u64))
