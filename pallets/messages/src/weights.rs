...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, ) -> Weight {
		Weight::from_ref_time(154_768_516 as u64)
			// Standard Error: 40
			.saturating_add(Weight::from_ref_time(1_668 as u64).saturating_mul(n as u64))
	...
	// Storage: Messages Messages (r:1 w:1)
	fn add_ipfs_message() -> Weight {
		Weight::from_ref_time(143_604_000 as u64)
