...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(8_521_000 as u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(1_000 as u64).saturating_mul(n as u64))
			// Standard Error: 2_000
			.saturating_add(Weight::from_ref_time(221_000 as u64).saturating_mul(m as u64))
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(382_000 as u64).saturating_mul(m as u64))
			// Standard Error: 153_000
			.saturating_add(Weight::from_ref_time(5_128_000 as u64).saturating_mul(s as u64))
