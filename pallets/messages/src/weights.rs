...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, m: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(285_000 as u64).saturating_mul(m as u64))
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(447_000 as u64).saturating_mul(m as u64))
			// Standard Error: 143_000
			.saturating_add(Weight::from_ref_time(5_310_000 as u64).saturating_mul(s as u64))
