...
//! DATE: 2022-08-03, STEPS: `20`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, m: u32, ) -> Weight {
		(26_671_000 as Weight)
			...
			.saturating_add((464_000 as Weight).saturating_mul(m as Weight))
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((916_000 as Weight).saturating_mul(m as Weight))
			// Standard Error: 555_000
			.saturating_add((12_921_000 as Weight).saturating_mul(s as Weight))
