...
//! DATE: 2022-08-08, STEPS: `20`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((622_000 as Weight).saturating_mul(m as Weight))
			// Standard Error: 384_000
			.saturating_add((9_238_000 as Weight).saturating_mul(s as Weight))
