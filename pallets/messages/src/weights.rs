...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, ) -> Weight {
		Weight::from_ref_time(139_313_678 as u64)
			// Standard Error: 42
			.saturating_add(Weight::from_ref_time(1_270 as u64).saturating_mul(n as u64))
	...
	// Storage: Messages Messages (r:1 w:1)
	fn add_ipfs_message() -> Weight {
		Weight::from_ref_time(125_741_000 as u64)
