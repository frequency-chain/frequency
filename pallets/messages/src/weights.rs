...
//! DATE: 2022-07-08, STEPS: `20`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add(_n: u32, m: u32, ) -> Weight {
		(113_571_000 as Weight)
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((685_000 as Weight).saturating_mul(m as Weight))
