...
//! DATE: 2022-12-15, STEPS: `50`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, ) -> Weight {
		Weight::from_ref_time(94_000_000 as u64)
			// Standard Error: 10
			.saturating_add(Weight::from_ref_time(556 as u64).saturating_mul(n as u64))
	...
	fn add_ipfs_message(n: u32, ) -> Weight {
		Weight::from_ref_time(80_000_000 as u64)
			// Standard Error: 13
			.saturating_add(Weight::from_ref_time(727 as u64).saturating_mul(n as u64))
