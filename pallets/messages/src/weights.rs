...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize(m: u32, s: u32, ) -> Weight {
		Weight::from_ref_time(0 as u64)
			...
			.saturating_add(Weight::from_ref_time(426_000 as u64).saturating_mul(m as u64))
			// Standard Error: 143_000
			.saturating_add(Weight::from_ref_time(5_066_000 as u64).saturating_mul(s as u64))
