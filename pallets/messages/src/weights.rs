...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_onchain_message(n: u32, ) -> Weight {
		Weight::from_ref_time(140_364_908 as u64)
			// Standard Error: 34
			.saturating_add(Weight::from_ref_time(1_344 as u64).saturating_mul(n as u64))
	...
	// Storage: Messages Messages (r:1 w:1)
	fn add_ipfs_message() -> Weight {
		Weight::from_ref_time(132_133_000 as u64)
