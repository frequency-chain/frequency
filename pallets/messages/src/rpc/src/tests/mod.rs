...
type GetMessagesBySchemaResult = Result<common_primitives::messages::BlockPaginationResponse<u32, common_primitives::messages::MessageResponse<u32>>, jsonrpsee::core::Error>;
...
async fn get_messages_by_schema_with_invalid_request_should_panic() {
    ...
    let result: GetMessagesBySchemaResult = api
		.get_messages_by_schema(
