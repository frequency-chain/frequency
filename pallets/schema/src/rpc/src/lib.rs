...
use sp_runtime::{DispatchError, generic::BlockId, traits::{Block as BlockT}};
use std::sync::Arc;
...
impl<C, Block, AccountId> SchemaApi<<Block as BlockT>::Hash, AccountId> 
	for SchemaHandler<C, Block>
	where
		Block: BlockT,
