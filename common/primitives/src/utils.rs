...
/// Paseo Genesis Hash 0x203c6838fc78ea3660a2f298a58d859519c72a5efdc0f194abd6f0d5ce1838e0
pub const PASEO_GENESIS_HASH: &[u8] = &[
...
pub fn get_chain_type_by_genesis_hash(genesis_hash: &[u8]) -> DetectedChainType {
	match genesis_hash {
		MAINNET_GENESIS_HASH => DetectedChainType::FrequencyMain,
		PASEO_GENESIS_HASH => DetectedChainType::FrequencyPaseo,
...
mod tests {
	...
	fn get_chain_type_by_genesis_hash_with_mainnet_genesis_should_get_mainnet() {
		...
		// assert
		assert_eq!(detected, DetectedChainType::FrequencyMain);
	}
	...
	fn get_chain_type_by_genesis_hash_with_paseo_genesis_should_get_paseo() {
		...
		// assert
		assert_eq!(detected, DetectedChainType::FrequencyPaseo);
	}
}
