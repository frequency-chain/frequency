...
3. Follow the instructions [here](https://docs.polkadot.com/develop/smart-contracts/local-development-node/) to make sure the Kitchensink Node and the Eth RPC Proxy are running.
